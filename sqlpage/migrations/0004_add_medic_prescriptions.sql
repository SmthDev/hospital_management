...
INSERT INTO patients (full_name, birth_date, phone, email) VALUES 
    ...
    ('Кузнецова Елена Викторовна', '2000-01-30', '+375292223344', 'kuznetsova@mail.com'),
    ('Морозов Дмитрий Андреевич', '1965-05-12', '+375295556677', 'morozov@mail.com'),
    ...
    ('Лебедева Наталья Ивановна', '1992-09-14', '+375298887766', 'lebedeva@mail.com'),
    ('Новиков Сергей Владимирович', '1975-12-03', '+375334445566', 'novikov@mail.com'),
    ('Федорова Ольга Сергеевна', '1983-04-27', '+375299991122', 'fedorova@mail.com')
ON CONFLICT DO NOTHING;
